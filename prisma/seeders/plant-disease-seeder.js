		...
		tomatoDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Bacterial%20Spot.jpg',
				created_at: new Date(),
				updated_at: new Date()
			},
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Early%20Blight.png',
				created_at: new Date(),
				updated_at: new Date()
			},
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Late%20Blight.jpg',
				created_at: new Date(),
				updated_at: new Date()
			},
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Leaf%20Mold.jpg',
				created_at: new Date(),
				updated_at: new Date()
			},
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Septoria%20Leaf%20Spot.jpg',
				created_at: new Date(),
				updated_at: new Date()
			},
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Two%20Spotted%20Spider%20Mites.jpg',
			},
			{
				id: 7,
				plant_id: 1,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Target%20Spot.jpg',
			},
			{
				id: 8,
				plant_id: 1,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Yellow%20Leaf%20Curl%20Virus.jpg',
			},
			{
				id: 9,
				plant_id: 1,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Tomato_Mosaic%20Virus.png',
			}
		],
		strawberryDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Strawberry_Leaf%20Scorch.jpg',
			}
		],
		bellPepperDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Bell%20Pepper_Bacterial%20Spot.jpg',
			}
		],
		squashDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Squash_Powdery%20Mildew.jpg',
			}
		],
		grapeDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Grape_Black%20Rot.jpg',
			},
			{
				id: 14,
				plant_id: 5,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Grape_Black%20Measles%20(Esca).jpg',
			},
			{
				id: 15,
				plant_id: 5,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Grape_Isariopsis%20Leaf%20Spot.jpg',
			}
		],
		appleDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Apple_Black%20Rot.jpg',
			},
			{
				id: 17,
				plant_id: 6,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Apple_Cedar%20Apple%20Rust.jpg',
			},
			{
				id: 18,
				plant_id: 6,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Apple_Scab.jpg',
			}
		],
		orangeDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Orange_Huanglongbing.jpg',
			}
		],
		potatoDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Potato_Early%20Blight.jpg',
			},
			{
				id: 21,
				plant_id: 8,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Potato_Late%20Blight.jpg',
			}
		],
		cornDisease: [
			{
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Corn_Grey%20Leaf%20Spot.png',
			},
			{
				id: 23,
				plant_id: 9,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Corn_Common%20Rust.png',
			},
			{
				id: 24,
				plant_id: 9,
				...
				image: 'https://storage.googleapis.com/plantpal-assets/diseases/Corn_Northern%20Leaf%20Blight.jpg',
			}
		],
	};
